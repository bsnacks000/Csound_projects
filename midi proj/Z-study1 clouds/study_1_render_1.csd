...
$VOICE(101'gk_tabrand_10'gk_random_1'gk_line_seg_1'gk_tabrand_1'gk_tabrand_7')
$VOICE(102'7'gk_random_2'gk_line_seg_1'gk_tabrand_3'gk_tabrand_9')
$VOICE(103'7'gk_random_3'gk_random_7'gk_tabrand_1'gk_tabrand_1')

$VOICE(104'6'gk_random_4'gk_random_8'gk_tabrand_2'gk_tabrand_2')
$VOICE(105'8'gk_random_5'gk_random_8'gk_tabrand_2'gk_tabrand_2')
...
$HIST_3. 0 15     .125 .25 .2   .25 .5 .3   .5 1.5 .4

;;------- SIL_HISTOGRAMS----------					$HIST_x 7- 12
$HIST_7. 0 15     0 0 .8   .125 .125 .2    0 0 0
$HIST_8. 0 15     0 0 .6   .125 .25  .3    .25 .333 .1
$HIST_9. 0 15     0 0 .5   .25  .5  .3     .5 .1 .2

;;-------- CHN_HISTOGRAMS -------------
$HIST_10. 0 15    1 1 .5   2 2 .5



;;----- FREQUENCY BANDWIDTH----------				$RANDOM_x
$RANDOM_1. 0 15     52 52   60 60  5 5      
$RANDOM_2. 0 15     24 24   38 38  5 5  
    
$RANDOM_3. 0 15     80 80   100 100 5 5 
$RANDOM_4. 0 15     53 45   53 60 5 5    
$RANDOM_5. 0 15     70 61   70 80 5 5
;;------ VELOCITY BANDWIDTH----------	


$RANDOM_7. 0 15      90 90   100 100 5 5	
$RANDOM_8. 0 15      65 65   90 90 5 5
;;------ VELOCITY LINE SEG ------------				$LINESEG_x

$LINESEG_1. 0 15     100  90 80  70
